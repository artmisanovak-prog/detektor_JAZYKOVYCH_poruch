...
6. Pod textem uvidíte seznam nalezených poruch s počty výskytů. Kliknutím na položku seznamu se můžete na dané místo v textu vrátit.
7. Výsledky si můžete uložit (zkopírovat) nebo vytisknout. Nástroj nic neukládá, vše je jen v prohlížeči.
